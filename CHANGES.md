...
SHIPPED so far: Base 2E, Intrigue 2E, Seaside 2E (Durations, mats; Outpost excluded pending extra turns), Prosperity 2E (VP tokens; basics toggle), Cornucopia (Prizes as non-supply stock), Guilds (Coffers + spend button), Hinterlands 2E (on-gain/discard reactions), Promos (7 of 11 — Stash/Sauna/Prince wait on mechanics). Still open, in build order:
- **Alchemy** — NEXT UP: Potion as a second cost currency in buy legality (core buy-action surgery, designed).
